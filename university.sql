...
CREATE TABLE dosen(
    ...
    idjurusan VARCHAR(20) NOT NULL, FOREIGN KEY(idjurusan) REFERENCES jurusan(idjurusan)); INSERT INTO dosen(namadosen,nip,idjurusan) VALUES('Tatan','5601','3401'),('Yeyen','5602','3402'),('Rendi','5603','3403'),('Jajang','5604','3401'),('Farid','5605','3405'),('Dani','5606','3404');
