...
// Berikut ini variable terpenting
var sql11 = "SELECT * FROM mahasiswa"; // cara bacanya sql 1-1
...
// Berikut ini fungsi paling penting
function mauApa(n) {
  // Ini fungsi CRUD
      ...
      case 41:
        db.all(sql41, (err, rows) => {
          ...
          if (rows) {
            ...
            // var table4 = new Table({ head: ["Kode", "Nama", "SKS", "Jurusan"] });
            // rows.forEach((matakuliah) => {
            //   table4.push([matakuliah.kodematkul, matakuliah.namamatkul, matakuliah.sks, matakuliah.idjurusan]);
            //   // console.log(`Kode Matakuliah Nama Matakuliah SKS Jurusan`);
            //   // rows.forEach((matakuliah) => {
            //   //   console.log(`${matakuliah.kodematkul} ${matakuliah.namamatkul} ${matakuliah.sks} ${matakuliah.idjurusan}`);
            // });
            // console.log(table4.toString());
            // pilihOpsi(4);
          } else {
...
function tampilOpsi() {
  // Ini fungsi pertama yang terdiri dari 6 opsi
  console.log("silahkan pilih opsi di bawah ini");
  console.log(
    "[1] Mahasiswa\n[2] Jurusan\n[3] dosen\n[4] mata kuliah\n[5] kontrak\n[6] keluar"
  );
